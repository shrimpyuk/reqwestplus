...
impl ClientBuilder {
    ...
    /// [`reqwestplus::blocking`][crate::blocking] for details.
    ...
    ///
    /// ```rust
    /// # fn doc() -> Result<(), reqwestplus::Error> {
    ...
    /// # fn build_client() -> Result<(), reqwestplus::Error> {
    ...
    /// let cert = reqwestplus::Certificate::from_der(&der)?;
    ///
    /// // get a client builder
    /// let client = reqwestplus::blocking::Client::builder()
...
impl Client {
    ...
    /// on [`reqwestplus::blocking`][crate::blocking] for details.
    pub fn new() -> Client {
