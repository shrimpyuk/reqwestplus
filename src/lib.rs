...
//! # reqwestplus
//!
//! The `reqwestplus` crate provides a convenient, higher-level HTTP
//! [`Client`][client].
//!
...
//! - Cookies
//!
//! The [`reqwestplus::Client`][client] is asynchronous. For applications wishing
//! to only make a few HTTP requests, the [`reqwestplus::blocking`](blocking) API
//! may be more convenient.
//!
//! Additional learning resources include:
//!
//! - [The Rust Cookbook](https://rust-lang-nursery.github.io/rust-cookbook/web/clients.html)
//! - [Reqwestplus Repository Examples](https://github.com/ignassew/reqwestplus/tree/master/examples)
//!
...
//!
//! ```rust
//! # async fn run() -> Result<(), reqwestplus::Error> {
//! let body = reqwestplus::get("https://www.rust-lang.org")
//!     .await?
//!     .text()
//!     .await?;
//!
...
//! type, you can use the `reqwestplus::Body` constructors.
//!
//! ```rust
...
//! i.e. `let proxy = reqwestplus::Proxy::http("https://secure.example")?;`
...
///
/// See also the methods on the [`reqwestplus::Response`](./struct.Response.html)
/// type.
///
...
/// ```rust
/// # async fn run() -> Result<(), reqwestplus::Error> {
/// let body = reqwestplus::get("https://www.rust-lang.org").await?
///     .text().await?;
/// # Ok(())
/// # }
/// ```
