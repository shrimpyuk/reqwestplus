...
impl Policy {
    ...
    ///
    /// ```rust
    /// # use reqwestplus::{Error, redirect};
    /// #
    /// # fn run() -> Result<(), Error> {
...
impl<'a> Attempt<'a> {
    ...
    /// Returns an action meaning reqwestplus should follow the next URL.
    ...
    /// Returns an action meaning reqwestplus should not follow the next URL.
    ///
