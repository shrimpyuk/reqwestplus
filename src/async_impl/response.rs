...
impl Response {
    ...
    /// let content = reqwestplus::get("http://httpbin.org/range/26")
    ///     .await?
    ///     .text()
    ///     .await?;
    ///
    ...
    /// let ip = reqwestplus::get("http://httpbin.org/ip")
    ///     .await?
    ///     .json::<Ip>()
    ///     .await?;
    ///
    ...
    /// ```
    /// # async fn run() -> Result<(), Box<dyn std::error::Error>> {
    /// let bytes = reqwestplus::get("http://httpbin.org/ip")
    ///     .await?
    ///     .bytes()
    ///     .await?;
    ///
    ...
    /// ```
    /// # async fn run() -> Result<(), Box<dyn std::error::Error>> {
    /// let mut res = reqwestplus::get("https://hyper.rs").await?;
    ///
    ...
    ///
    /// # async fn run() -> Result<(), Box<dyn std::error::Error>> {
    /// let mut stream = reqwestplus:get("http://httpbin.org/ip")
    ///     .await?
    ///     .bytes_stream();
    ///
    ...
    ///             assert_eq!(
    ///                 err.status(),
    ///                 Some(reqwestplus::StatusCode::BAD_REQUEST)
    ///             );
    ///         }
    ///     }
    /// }
